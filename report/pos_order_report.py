...
class PosOrderReport(models.Model):
    ...
    tipodocto=fields.Char(string='TipoDocumento')
    nrodocumento=fields.Char(string='NroDocumento')
...
SELECT
                ...
                s.sii_document_number as nrodocumento
        """
...
FROM pos_order_line AS l
                ...
                left join sii_document_class sdc on sdc.id =s.document_class_id 
        """
    ...
    def _group_by(self):
        return """
            GROUP BY
                ...
                p.product_tmpl_id,
                ps.config_id,
                pt.marca_id,mmm.es_propia,sdc.name,s.sii_document_number   
        """
